...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tag_list = __webpack_require__(159);

	var _tag_list2 = _interopRequireDefault(_tag_list);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = _react2.default;
	exports.default = _tag_list2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tags_container = __webpack_require__(160);

	var _tags_container2 = _interopRequireDefault(_tags_container);
	...
	var TagList = _react2.default.createClass({
	  ...
	  propTypes: {
	    ...
	    tags: _react2.default.PropTypes.any
	  },
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    this.refs.tag_input.addEventListener('keydown', function (e) {
	      if (_this.separators.indexOf(e.which) !== -1) {
	        e.preventDefault();
	      }
	    ...
	    this.refs.tag_input.addEventListener('keyup', function (e) {
	      var matches = e.target.value.match(_this.forbidden);
	      if (matches) {
	        _this.refs.tag_input.value = e.target.value.replace(matches[0], '');
	        e.preventDefault();
	      }

	      // DELETERS
	      if (_this.deleters.indexOf(e.which) !== -1 && e.target.value.length === 0) {
	        e.preventDefault();
	        _this.setState({
	          deleteCount: _this.state.deleteCount += 1
	        }, function () {
	          if (_this.state.deleteCount === 2) {
	            _this.removeLastTag();
	          }
	        });
	      }
	      ...
	      if (_this.separators.indexOf(e.which) !== -1) {
	        e.preventDefault();
	        _this.addStringToTagList(_this.refs.tag_input.value);
	        _this.clearTagInput();
	      }

	      // CANCELERS
	      if (_this.cancelers.indexOf(e.which) !== -1) {
	        e.preventDefault();
	        _this.clearTagInput();
	      }
	    });
	  ...
	  initWithTags: function initWithTags() {
	    var _this2 = this;

	    this.setState({
	      tags: this.removeDuplicates(this.props.tags.split(',').map(function (tag) {
	        return _this2.cleanTag(tag);
	      }))
	    }, function () {
	      _this2.refs.hidden_input.value = _this2.state.tags.join(', ');
	    });
	  },

	  removeLastTag: function removeLastTag() {
	    if (this.state.tags.length > 0) {
	      var newTags = this.state.tags.slice(0, -1);
	  ...
	  cleanTag: function cleanTag(string) {
	    return string.trim().replace(',', '').replace(' ', '');
	  },

	  removeDuplicates: function removeDuplicates(tags) {
	    var seen = new Set();
	  ...
	  addStringToTagList: function addStringToTagList(string) {
	    var _this3 = this;
	    ...
	    if (string !== "") {
	      this.setState({
	        ...
	        _this3.refs.hidden_input.value = _this3.state.tags.join(', ');
	      });
	    }
	  },

	  clearTagInput: function clearTagInput() {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { className: 'tag_list', onClick: this.focusTagInput },
	      _react2.default.createElement(_tags_container2.default, {
	        removeTag: this.removeTagAtIndex,
	        tags: this.state.tags }),
	      _react2.default.createElement('input', { type: 'text', ref: 'tag_input', size: this.state.inputSize }),
	      _react2.default.createElement('input', { type: 'hidden', ref: 'hidden_input', name: this.props.name })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tag = __webpack_require__(161);
	...
	var TagsContainer = _react2.default.createClass({
